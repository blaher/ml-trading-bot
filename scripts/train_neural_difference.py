...
# Import data
data = pd.read_csv('data/SPY_neural_difference.csv', delimiter=', ', encoding="utf-8-sig")
print(data)
y_min = data['futureHighCloseDelta'].min()
y_max = data['futureHighCloseDelta'].max()
...
while 1 == 1:
    ...
    if first == 1 or mse_test[-1] < lowest_mse:
        ...
        saver.save(net, 'algorithms/neural-difference')
